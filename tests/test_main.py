...
class TestFpsParsing(unittest.TestCase):
    ...
    def test_invalid(self):
        self.assertRaises(
            common.PrassError, lambda: prass.parse_fps_string("24000/1001/1")
        )
        self.assertRaises(
            common.PrassError, lambda: prass.parse_fps_string("not a number")
        )
...
class TestShiftParsing(unittest.TestCase):
    ...
    def test_timestamp(self):
        ...
        self.assertAlmostEqual(
            (12 * 3600 + 15 * 60) * 1000 + 23128,
            prass.parse_shift_string("12:15:23.128"),
        )

    def test_invalid(self):
        self.assertRaises(
            common.PrassError, lambda: prass.parse_shift_string("1:1:1:1")
        )
        self.assertRaises(
            common.PrassError, lambda: prass.parse_shift_string("123seconds")
        )
        self.assertRaises(
            common.PrassError, lambda: prass.parse_shift_string("not a number")
        )
...
class TestResolutionParsing(unittest.TestCase):
    ...
    def test_invalid(self):
        self.assertRaises(
            common.PrassError, lambda: prass.parse_resolution_string("720")
        )
        self.assertRaises(
            common.PrassError, lambda: prass.parse_resolution_string("1920.1080")
        )
        self.assertRaises(
            common.PrassError, lambda: prass.parse_resolution_string("1963p")
        )
        self.assertRaises(
            common.PrassError, lambda: prass.parse_resolution_string("not a number")
        )
